...
/* Bit 0 in _gc_next is the alive tag bit.
 *
 * During a collection of the oldest generation all alive objects removed from
 * cyclic GC.
*/
#define _PyGC_NEXT_MASK_ALIVE_TAG    1
    ...
    PyObject *op)
{
    ...
    gc->_gc_next = ((uintptr_t)generation0) | gcstate->alive_tag;
